<?php /* Template Name: C2 Will County Page */ ?>
...
<div class="about-mow-page-programs-application">
                      <h2>Apply For
                        <span>Meals on Wheels In Will County</span></h2>
                        <div class="ccu-info">
                            <aside>
            ...
            <div class="about-mow-page-locations-content">
                ...
                <article class="map-locations">
                    ...
                    <?php 
                    $args = array( 'post_type' => 'c2-locations', 'tag' => 'c2-will-county', 'posts_per_page' => 100, 'orderby' => 'title',
                    'order'   => 'ASC' );
